...
//        }
    ...
    public static int sellItem(Basket basket, String item, int quanity) {
        ...
        if (stockItem == null) {
            System.out.println("we dont sell this " + item);
            return 0;
        }
        if (stockList.reserveStock(item, quanity) > 0) {
            return basket.addToBasket(stockItem, quanity);
        }
        return 0;
    }
